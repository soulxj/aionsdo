...
import com.aionemu.gameserver.model.motion.MotionLog;
import com.aionemu.gameserver.model.motion.SkillTime;
import com.aionemu.gameserver.model.motion.WeaponTime;
...
public class MotionLoggingService {
	...
	public int calculateFrequency(List<Integer> list, int value) {
		int frequency = 0;
