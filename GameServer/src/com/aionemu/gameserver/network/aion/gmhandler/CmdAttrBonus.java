...
public class CmdAttrBonus extends AbstractGMHandler implements StatOwner {
	...
	private void run() {
		...
		PacketSendUtility.broadcastPacket(tgtPlayer, new S_ACTION(tgtPlayer, EmotionType.START_EMOTE2, 0, 0), true);
	}
	...
	enum AttrBonusAction {
		...
		ARPERIFICATION("ARPERIFICATION", StatEnum.PARALYZE_RESISTANCE),
		...
		//PERIFICATION_ARP("PERIFICATION ARP", StatEnum.PETRIFICATION_RESISTANCE_PENETRATION),
...
//					break;
//				case PETRIFICATION_RESISTANCE_PENETRATION:
