...
//import com.aionemu.gameserver.skillengine.model.SkillCD;
import com.aionemu.gameserver.model.gameobjects.player.Player;
...
//            for (Entry<Integer, SkillCD> en : playerT.getSkillCoolDowns().entrySet()) {
//                delayIds.add(en.getKey());
//            }
//            for (Integer delayId : delayIds) {
//                playerT.setSkillCoolDown(delayId, playerT.getSkillCoolDowns().get(delayId).base, currentTime);
//            }
//            delayIds.clear();
//            PacketSendUtility.sendPacket(playerT, new SM_SKILL_COOLDOWN(playerT.getSkillCoolDowns(), playerT, false));
//        }
//
