		...
		if (activePlayer.isLegionMember()) {
			...
			if (charName != null) {
				...
				switch (exOpcode) {
					...
					/** Edit Join Setting **/
					case 0x10:
						GuildSearchService.getInstance().updateLegionJoinSettings(activePlayer, joinDescription, joinType, minLevel, mainActivity);
						break;
					/** Accept Join Request **/
					case 0x11:
						GuildSearchService.getInstance().handleJoinRequestAcceptAnswer(activePlayer, playerId);
						break;
					/** Decline Join Request **/
					case 0x12:
						GuildSearchService.getInstance().handleJoinRequesDeclineAnswer(activePlayer, playerId);
						break;
