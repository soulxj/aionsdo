...
public class CM_CREATE_CHARACTER extends AionClientPacket {
    ...
    protected void readImpl() {
        ...
        playerCommonData.setNpcExpands(AdvCustomConfig.CUBE_SIZE);
        playerCommonData.setWardrobeSlot(11);
    ...
    protected void runImpl() {
        ...
        if (!PlayerService.storeNewPlayer(player, account.getName(), account.getId())) {
            ...
            PlayerAccountData accPlData = new PlayerAccountData(playerCommonData, null, playerAppearance, equipment, null, player.getPlayerSettings(), 0);
