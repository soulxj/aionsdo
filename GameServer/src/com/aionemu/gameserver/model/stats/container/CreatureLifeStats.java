...
public abstract class CreatureLifeStats<T extends Creature>
{
	...
	public int increaseHp(TYPE type, int value, int skillId) {
		return this.increaseHp(type, value, skillId, LOG.REGULAR);
	}
	...
	public int increaseMp(TYPE type, int value, int skillId) {
		return this.increaseMp(type, value, skillId, LOG.REGULAR);
	}
