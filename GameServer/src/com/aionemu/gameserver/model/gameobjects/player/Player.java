...
public class Player extends Creature
{
	...
	private FastMap<Integer, EquipmentSetting> playerEquipSettingList = FastMap.newInstance();
	...
	public void putPlayerEquipSettingList(EquipmentSetting macross) {
		playerEquipSettingList.put(macross.getMacrossId(), macross);
	}

	public FastMap<Integer, EquipmentSetting> getPlayerEquipSettingList() {
		return playerEquipSettingList;
	}

	public  EquipmentSetting removePlayerEquipMacross(int index) {
		return playerEquipSettingList.remove(index);
	}

	public void updateLastEquip() {
		this.lastEquipTime = System.currentTimeMillis();
	}
		
	public boolean canEquip(int time) {
		return System.currentTimeMillis() - this.lastEquipTime < time ? false : true;
	}
}