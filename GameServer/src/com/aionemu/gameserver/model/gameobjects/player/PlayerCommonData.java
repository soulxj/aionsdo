...
public class PlayerCommonData extends VisibleObjectTemplate
{
	...
	private int advencedStigmaSlotSize = 11;
	...
	public boolean isReadyForSalvationPoints() {
		return this.level >= 15 && level < GSConfig.PLAYER_MAX_LEVEL + 1;
	}
	...
	public void setSp(int sp) {
		if (getPlayer() != null) {
			int maxSp = getPlayer().getGameStats().getMaxSp().getCurrent();
			this.sp = sp > maxSp ? maxSp : sp;
