	...
	private void sendCastspellEnd(int spellStatus, int dashStatus, List<Effect> effects) {
		if ((this.skillMethod == SkillMethod.CAST)) {
            switch (this.targetType) {
                case 0:
                    PacketSendUtility.broadcastPacketAndReceive(effector, new S_SKILL_SUCCEDED(this, effects, serverTime, chainSuccess, spellStatus, dashStatus)); 
               break;
                case 3:
                	PacketSendUtility.broadcastPacketAndReceive(effector, new S_SKILL_SUCCEDED(this, effects, serverTime, chainSuccess, spellStatus, dashStatus));
                break;
                case 1:
                	PacketSendUtility.broadcastPacketAndReceive(effector, new S_SKILL_SUCCEDED(this, effects, serverTime, chainSuccess, spellStatus, dashStatus, targetType));
				break;
            }
