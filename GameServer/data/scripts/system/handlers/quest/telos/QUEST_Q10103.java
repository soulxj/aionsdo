        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            ...
            if (targetId == 800678) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
                    ...
                    if (player.getInventory().getItemsByItemId(182209904) != null && player.getInventory().getItemsByItemId(182209903) != null) {
                        List<Item> toRemove = new LinkedList<>();
                        toRemove.addAll(player.getInventory().getItemsByItemId(182209904));
                        toRemove.addAll(player.getInventory().getItemsByItemId(182209903));
                        toRemove.forEach(item -> {
                            removeQuestItem(env, item.getItemId(), item.getItemCount());
                        });
                    }
