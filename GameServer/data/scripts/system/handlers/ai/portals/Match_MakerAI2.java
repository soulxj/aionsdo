...
public class Match_MakerAI2 extends PortalAI2
{
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		if (questId > 0 && QuestEngine.getInstance().onDialog(env)) {
		...
		} else if (dialogId == DialogAction.MATCH_MAKER.id()) {
			...
			PacketSendUtility.sendPacket(player, new S_NPC_HTML_MESSAGE(getObjectId(), 5));
		} else {
			if (questId == 0) {
