...
public class Tempus extends GeneralInstanceHandler
{
	...
	protected final int IDF4RE_SOLO_POLYMORPH_2 = 20499;
	protected final int IDF4RE_SOLO_SIEL_BOMB = 20500;
	...
	public void handleUseItemFinish(final Player player, final Npc npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 800584: //idf4re_solo_fobj_drakanbox.
				despawnNpc(npc);
				SkillEngine.getInstance().applyEffectDirectly(IDF4RE_SOLO_POLYMORPH_2, player, player, 7200000 * 1);
			break;
	...
	private void removeEffects(Player player) {
		...
		effectController.removeEffect(IDF4RE_SOLO_POLYMORPH_2);
	}
