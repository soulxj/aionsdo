...
public class Esoterrace extends GeneralInstanceHandler
{
	...
	private void reianSurvivor() {
		moveToForward((Npc)spawn(799626, 1142.0000f, 679.0000f, 296.0000f, (byte) 10), 1244.0000f, 734.0000f, 296.0000f, false);
		moveToForward((Npc)spawn(799627, 1143.0000f, 676.0000f, 296.0000f, (byte) 10), 1252.0000f, 735.0000f, 297.0000f, false);
	}
