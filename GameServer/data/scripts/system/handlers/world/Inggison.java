...
public class Inggison extends GeneralWorldHandler
{
    ...
    public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			case 215584: //Titan Starturtle.
				...
				spawn(210050000, 700545, 338.0000f, 573.0000f, 458.0000f, (byte) 0, 755);
			break;
			case 216849: //Watcher Garma.
				//A gust of air bursts forth.
				sendMsgByRace(1400486, Race.PC_ALL, 0);
				spawn(210050000, 700545, 2602.0000f, 1526.0000f, 258.0000f, (byte) 0, 754);
			break;
			case 216848: //Illanthe Hundredyears.
				//A gust of air bursts forth.
				sendMsgByRace(1400486, Race.PC_ALL, 0);
				spawn(210050000, 700545, 1745.0000f, 1716.0000f, 226.0000f, (byte) 0, 1039);
			break;
			case 217071: //Esalki The Fourth.
				//A gust of air bursts forth.
				sendMsgByRace(1400486, Race.PC_ALL, 0);
				spawn(210050000, 700545, 2288.0000f, 1067.0000f, 285.0000f, (byte) 0, 2311);
			break;
			case 217072: //Huge Waterfall Starturtle.
				//A gust of air bursts forth.
				sendMsgByRace(1400486, Race.PC_ALL, 0);
				spawn(210050000, 700545, 1660.0000f, 928.0000f, 404.0000f, (byte) 0, 2292);
			break;
			///HUGE GRYPHU EGG.
			case 217095:
			    despawnNpc(npc);
	...
	public void onSpawn(Npc npc) {
		switch (npc.getNpcId()) {
			...
			break;
			case 700545: ///Ancient Windstream.
				ThreadPoolManager.getInstance().schedule(new Runnable() {
				    @Override
					public void run() {
						despawnNpcs(getNpcs(700545));
					}
				}, 610000);
			break;
