...
public class MySQL5AccountBlackCloudDAO extends AccountBlackCloudDAO {


    private Logger log = LoggerFactory.getLogger(MySQL5AccountBlackCloudDAO.class);

    @Override
    public Map<Integer, BlackcloudLetter> loadAccountBlackcloud(Account account) {
    ...
    @Override
    public boolean addBlackcloud(Account account, BlackcloudLetter blackcloudLetter) {
        Connection con = null;
        try {
    ...
    @Override
    public boolean updateBlackcloud(int i) {
        return false;
    }

    @Override
    public void deleteBlackcloud(int id) {
    ...
    @Override
    public List<BlackcloudItem> loadBlackcloudItem(BlackcloudLetter blackcloudLetter) {
    ...
    @Override
    public boolean addBlackcloudItem(BlackcloudItem blackcloudItem) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public void deleteBlackcloudItem(int id) {
    ...
    public int[] getUsedIDs() {
        PreparedStatement statement = DB.prepareStatement("SELECT id FROM account_blackcloud", ResultSet.TYPE_SCROLL_INSENSITIVE,
