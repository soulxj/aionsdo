...
public class MySQL5PlayerBattlePassDAO extends PlayerBattlePassDAO {
    ...
    @Override
    public boolean storeSeason(Player player, BattlePassSeason season) {
        Connection con = null;
        try {
    ...
    @Override
    public boolean updateSeason(Player player, BattlePassSeason season) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public boolean storeReward(Player player, BattlePassReward reward, int seasonId) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public boolean updateReward(Player player, BattlePassReward reward) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public boolean storeQuest(Player player, BattlePassQuest quest) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public boolean updateQuest(Player player, BattlePassQuest quest) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public Map<Integer, BattlePassSeason> loadPlayerBattlePass(final Player player) {
    ...
    @Override
    public Map<Integer, BattlePassReward> loadPlayerBattleReward(final int season, final Player player) {
    ...
    @Override
    public Map<Integer, BattlePassQuest> loadPlayerBattleQuest(final Player player) {
    ...
    @Override
    public void deleteQuest(BattleQuestType type) {
    ...
    public int[] getUsedIDs() {
        PreparedStatement statement = DB.prepareStatement("SELECT object_id FROM player_battle_pass_quest",
