...
public class MySQL5PlayerWardrobeDAO extends PlayerWardrobeDAO {
    ...
    private Logger log = LoggerFactory.getLogger(MySQL5PlayerWardrobeDAO.class);
    ...
    @Override
    public void loadWardrobe(Player player) {
    ...
    @Override
    public boolean addItem(Player player, WardrobeEntry wardrobeEntry) {
        Connection con = null;
        try {
    ...
    @Override
    public boolean updateItem(Player player, WardrobeEntry wardrobeEntry) {
        Connection con = null;
        try {
            con = DatabaseFactory.getConnection();
    ...
    @Override
    public void deleteItem(Player player, WardrobeEntry wardrobeEntry) {
    ...
    public int[] getUsedIDs() {
        PreparedStatement statement = DB.prepareStatement("SELECT object_id FROM player_wardrobe", ResultSet.TYPE_SCROLL_INSENSITIVE,
