...
CREATE TABLE `account_data` (
  ...
  `membership_expire` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=542778 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for inventory_wardrobe
-- ----------------------------
